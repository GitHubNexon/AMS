...
const OutPutTaxReport = () => {
  ...
  const handleFetchReport = async () => {
    ...
    try {
      ...
      const response = await EntriesReportApi.getAlphaListOutPutTaxReport(
        formattedStartDate,
        formattedEndDate
      );
  ...
  const handleExportReport = () => {
    ExportApi.exportAlphaListOutputTaxReport(Grandtotal, reportData);
  };
  ...
  return (
    <>
      ...
      <div className="mx-auto p-4 overflow-auto">
        ...
        <h1 className="text-xl font-bold mb-4">LIST OF OUTPUT TAXES</h1>
                ...
                <tbody className="text-[0.6em]">
                  ...
                  {getCurrentPageData().map((entry, index) => (
                    <tr key={index} className="bg-white">
                      ...
                      <td className="border border-gray-300 px-4 py-2 text-center">
                        {numberToCurrencyString(entry.grossSales)}
                      </td>
                      <td className="border border-gray-300 px-4 py-2 text-center">
                        {numberToCurrencyString(entry.exemptSales)}
                      </td>
                      <td className="border border-gray-300 px-4 py-2 text-center">
                        {numberToCurrencyString(entry.zeroRateSales)}
                      </td>
                      <td className="border border-gray-300 px-4 py-2 text-center">
                        {numberToCurrencyString(entry.amountOfTaxableSales)}
                      </td>
                      <td className="border border-gray-300 px-4 py-2 text-center">
                        {numberToCurrencyString(entry.outputTaxAmount)}
                      </td>
                      <td className="border border-gray-300 px-4 py-2 text-center">
                        {numberToCurrencyString(entry.grossTaxableSales)}
                      </td>
                    </tr>
                  ))}
                </tbody>
                ...
                <tfoot>
                  <tr className="font-bold">
                    ...
                    <td className="border border-gray-300 px-4 py-2">
                      {numberToCurrencyString(Grandtotal.grossSales)}
                    </td>
                    <td className="border border-gray-300 px-4 py-2">
                      {numberToCurrencyString(Grandtotal.exemptSales)}
                    </td>
                    <td className="border border-gray-300 px-4 py-2">
                      {numberToCurrencyString(Grandtotal.zeroRateSales)}
                    </td>
                    <td className="border border-gray-300 px-4 py-2">
                      {numberToCurrencyString(Grandtotal.amountOfTaxableSales)}
                    </td>
                    <td className="border border-gray-300 px-4 py-2">
                      {numberToCurrencyString(Grandtotal.outputTaxAmount)}
                    </td>
                    <td className="border border-gray-300 px-4 py-2">
                      {numberToCurrencyString(Grandtotal.grossTaxableSales)}
                    </td>
                  </tr>
                </tfoot>
              </table>
...
export default OutPutTaxReport;
