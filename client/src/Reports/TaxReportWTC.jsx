...
const TaxReportWTC = () => {
  ...
  const handleFetchReport = async () => {
    ...
    try {
      ...
      const response = await EntriesReportApi.getReportForWTC(
        formattedStartDate,
        formattedEndDate,
        ownerName
      );
  ...
  return (
    <>
      <div className="mx-auto p-4 overflow-auto">
        <h1 className="text-xl font-bold mb-4">WITHHOLDING TAX REPORT WTC</h1>
      </div>
