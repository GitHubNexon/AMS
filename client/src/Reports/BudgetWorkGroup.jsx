...
const BudgetWorkGroup = () => {
  ...
  const handleFetchReport = async () => {
    ...
    try {
      ...
      const response = await BudgetTrackApi.getWorkGroupBudget(
        formattedStartDate,
        formattedEndDate,
        workGroupCodes,
        categoryCodes
  ...
  return (
    <>
      <div className="mx-auto p-4 overflow-auto">
        <h1 className="text-xl font-bold">Budget WorkGroup Report</h1>
      </div>
              ...
              <tbody className="text-[0.7em]">
                {getCurrentPageData().map((report, index) => (
                  <tr key={index} className="bg-white">
                    ...
                    <td className="border border-gray-300 px-4 py-2">
                      {numberToCurrencyString(report.TotalCurrentBalance)}
                    </td>
                    <td className="border border-gray-300 px-4 py-2">
                      {numberToCurrencyString(report.AverageCategoryPercentage)}
                      %
                    </td>
                  </tr>
                ))}
...
export default BudgetWorkGroup;
