...
const TaxReportWPT = () => {
  ...
  const handleFetchReport = async () => {
    ...
    try {
      ...
      const response = await EntriesReportApi.getReportForWPT(
        formattedStartDate,
        formattedEndDate,
        ownerName
      );
  ...
  const handleExportReport = () => {
    ExportApi.exportWPTReport(
      reportData,
      Grandtotal.totalIncomePayment,
      Grandtotal.totalTaxRate,
      Grandtotal.totalTaxTotal
    );
  };
  ...
  return (
    <>
      <div className="mx-auto p-4 overflow-auto">
        <h1 className="text-xl font-bold mb-4">WITHHOLDING TAX REPORT WPT</h1>
      </div>
