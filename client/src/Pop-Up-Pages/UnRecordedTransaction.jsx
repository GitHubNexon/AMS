...
export const UnRecordedTransaction = ({ isOpen, data, onClose }) => {
      ...
      <div className="w-[70vw] h-auto max-h-[90vh] overflow-scroll m-10 rounded-lg shadow-lg bg-white p-7 text-[0.8rem]">
        ...
        >
          ...
          <div className="overflow-auto">
            <h2 className="text-lg font-bold mb-4">Unrecorded Checks</h2>
...
export default UnRecordedTransaction;
