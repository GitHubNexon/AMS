...
const ParModal = ({ isOpen, onClose, employeeAssetsData }) => {
  ...
  const { entityName, fundCluster, parNo, assetRecords, dateReleased } =
    employeeAssetsData;
      ...
      >
        ...
        <div className="flex justify-between items-center p-4 border-b border-gray-200 no-print">
          <div className="flex items-center">
            ...
            <h2 className="text-xl font-bold text-gray-800 mr-5">
            ...
            <div className="header-grid grid grid-cols-2 gap-6 mb-6">
              ...
              <div className="space-y-3">
                ...
                {/* <div className="flex flex-col">
                  ...
                  <span className="font-semibold text-gray-800">
                    {formatReadableDate(dateReleased)}
                  </span>
                </div> */}
              </div>
            </div>
              ...
              <table className="min-w-full bg-white border border-gray-200">
                ...
                <tbody>
                  {assetRecords &&
                    assetRecords.map((asset, index) => (
                      ...
                      >
                        ...
                        <td className="py-2 px-3 border">{asset.category}</td>
                        <td className="py-2 px-3 border">
                          {`${asset.propName} - ${asset.condition}`}
                        </td>
                        <td className="py-2 px-3 border">{asset.propNo}</td>
                        <td className="py-2 px-3 border">
                          {formatReadableDate(asset.dateAcquired)}
                        </td>
                  ...
                  <tr className="bg-gray-100 font-bold">
                    <td colSpan="5" className="py-2 px-3 border text-right">
                      Total:
                    </td>
                    <td className="py-2 px-3 border text-right">
