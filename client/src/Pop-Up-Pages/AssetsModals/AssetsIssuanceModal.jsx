...
import AutoGeneratedParNo from "../../Components/AssetsComponents/AutoGeneratedParNo";
import AssetsInventoryIssuanceTab from "./AssetsInventoryIssuanceTab";
...
const AssetsIssuanceModal = ({
  ...
  // Handle PAR No change from AutoGeneratedParNo component
  const handleParNoChange = (newParNo) => {
    setFormData((prevData) => ({
      ...prevData,
      parNo: newParNo,
    }));
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 text-[0.7em]">
              <div className="flex flex-col">
                ...
                <AutoGeneratedParNo
                  ...
                  onChange={handleParNoChange}
                  disabled={mode === "edit"}
                  placeholder="Auto-generated PAR No"
                  autoGenerate={mode !== "edit"}
                />
              </div>
              <div className="flex flex-col">
