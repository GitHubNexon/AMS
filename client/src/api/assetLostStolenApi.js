...
const assetLostStolenApi = {
    ...
    getAllAssetsLostStolenRecord: async (
        ...
        const response = await axios.get(`${API_BASE_URL}/assets-lost-stolen/get-all`, {
    ...
    undoDeleteAssetsLostStolenRecord: async (id) => {
        try {
            ...
            console.error("Error undoing delete for assets lost/stolen:", error.message);
            throw error;
        }
    },
    undoArchiveAssetsLostStolenRecord: async (id) => {
        try {
            ...
            console.error("Error undoing archive for assets lost/stolen:", error.message);
            throw error;
        }
    },
}
