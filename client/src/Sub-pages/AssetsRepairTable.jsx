...
const AssetsRepairTable = () => {
  ...
  const handleDeleteEntry = (id) =>
    handleActionButtons({
      ...
      apiMethod: assetRepairApi.deleteAssetsRepairRecord,
    });
  ...
  const handleUndoDeleteEntry = (id) =>
    handleActionButtons({
      ...
      apiMethod: assetRepairApi.undoDeleteAssetsRepairRecord,
    });
  ...
  const handleArchiveEntry = (id) =>
    handleActionButtons({
      ...
      apiMethod: assetRepairApi.archiveAssetsRepairRecord,
    });
  ...
  const handleUndoArchiveEntry = (id) =>
    handleActionButtons({
      ...
      apiMethod: assetRepairApi.undoArchiveAssetsRepairRecord,
    });
